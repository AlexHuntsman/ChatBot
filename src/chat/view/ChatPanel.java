...
private void setupLayout()
{
	...
	baseLayout.putConstraint(SpringLayout.SOUTH, textPane, -90, SpringLayout.SOUTH, this);
	baseLayout.putConstraint(SpringLayout.EAST, textPane, -50, SpringLayout.EAST, this);
	baseLayout.putConstraint(SpringLayout.NORTH, textField, 6, SpringLayout.SOUTH, textPane);
	baseLayout.putConstraint(SpringLayout.WEST, textField, 0, SpringLayout.WEST, textPane);
	baseLayout.putConstraint(SpringLayout.EAST, textField, 0, SpringLayout.EAST, textPane);
}
